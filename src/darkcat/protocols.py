...
Recognized darknet / overlay / underground / obscure protocols (47 total):
  ...
  Anonymous overlays
    ...
    - Veilid                  veilid://, vld0:    — anonymous P2P (cDc, 2023)
    - Nym                     nym://              — Sphinx mixnet (Loopix-based)
  ...
  Distributed / content-addressed web
    ...
    - Cabal                   cabal://<key>
    - Arweave permaweb        ar://<txid>         — fetches via gateway
  ...
  Messaging / F2F
    ...
    - bitchat (BLE mesh)      bitchat://<peer-or-channel>
    - SimpleX SMP             simplex://, smp:// — Simple Messaging Protocol,
                              the only chat protocol with no user identifiers
    - Session                 session://<id>     — Oxen-routed anon chat
    - Berty                   berty://#/...      — P2P offline-first mesh chat
    - Jami (formerly Ring)    jami:, ring:       — distributed SIP / chat
    - Nostr                   nostr:npub1…/nevent1…/nprofile1…/naddr1…
...
_SCHEME_TO_PROTOCOL: dict[str, Protocol] = {
    ...
    "bitchat": Protocol.BITCHAT,
    "simplex": Protocol.SIMPLEX,
    "smp": Protocol.SIMPLEX,
    "session": Protocol.SESSION,
    "berty": Protocol.BERTY,
    "jami": Protocol.JAMI,
    "ring": Protocol.JAMI,
    "nostr": Protocol.NOSTR,
    "veilid": Protocol.VEILID,
    "vld0": Protocol.VEILID,
    "nym": Protocol.NYM,
    "ar": Protocol.ARWEAVE,
